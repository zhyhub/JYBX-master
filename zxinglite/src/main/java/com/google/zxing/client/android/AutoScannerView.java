...
public class AutoScannerView extends View {
    ...
    private final int triAngleColor = Color.parseColor("#0e7ff8");                        //边角的颜色
    private final int lineColor = Color.parseColor("#0e7ff8");                            //中间线的颜色
    ...
    private final int textMarinTop = dp2px(40);                                           //文字距离识别框的距离
